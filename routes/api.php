...
use App\Http\Controllers\API\AbonentController;
...
Route::middleware('auth:api')->get('/abonents', [AbonentController::class, 'index']);         // список абонентів
...
Route::middleware('auth:api')->get('/abonents/{id}', [AbonentController::class, 'show']);     // картка абонента
