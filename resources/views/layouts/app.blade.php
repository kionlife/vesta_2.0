...
<div class="page-container">
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu">
            <ul id="menu" >
                <li><a href="/home"><i class="fa fa-tachometer"></i> <span>Головна</span></a></li>
                <li><a href="/counters"><i class="fa fa-tachometer"></i> <span>Показники</span></a></li>
                <li><a href="/abonents"><i class="fa fa-tachometer"></i> <span>Абоненти</span></a></li>
                <li><a href="/home"><i class="fa fa-tachometer"></i> <span>Квитанції</span></a></li>
                <li><a href="/home"><i class="fa fa-tachometer"></i> <span>Коригування балансів</span></a></li>
                <li><a href="/home"><i class="fa fa-tachometer"></i> <span>Платежі</span></a></li>
